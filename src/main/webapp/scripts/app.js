...
var blognrApp = angular.module('blognrApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'blognrAppUtils', 'pascalprecht.translate', 'truncate']);
